...
parser.add_argument('--layersName',type=str, required=True)
parser.add_argument('--fibersName',type=str, required=True)
parser.add_argument('--atName',type=str, required=True)
...
values1 = meshLayersFibs.point_data[args.layersName]
...
values1 = meshLayersFibs.point_data[args.fibersName]
values2 = RBFInterpolator(points1, values1, neighbors=100)(points2)
