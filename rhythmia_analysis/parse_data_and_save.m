...
tic
base_path    = '/home/maxi/Documents/PhD/Paper3/Study_2024_04_23_09-06';
input_path   = append(base_path, '/map1_LV_.mat');
out_path     = append(base_path, '/results/map1');
...
if full
    ...
    save(file_se, "se_location", "se_projected_dist", ...
        "se_activation_uni", "se_activation_bi", "se_voltage_uni", ...
        "se_voltage_bi");
end
