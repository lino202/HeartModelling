function main(data_path, experiment_name, Fs, stimPeriod, dt, replevel)
    % Obtain the APD vs time
    % data_path = 'D:/Paper3/Cell_sims/final/mi/gaur_endo_mi_030gk1_1000s/';
    % experiment_name = 'gaur_endo_mid_030gk1_1000s_Vm';
    % Fs                      = 1000;                                % 1 KHz
