function [positionqrs]=wavedelianation_func(carpetabiosig,sigdir,signal, fs, flags)
    % INPUT:
    ...
    % Detector QRS
    save(strcat(sigdir,'ecg_nm_f.mat'),'signal','fs','-mat');
    headir = sigdir;
    matdir = sigdir;
    ecgnr = 'ecg_nm_f'; % .mat with 1 lead %'signal'
    t=[];
    ...
    delete(strcat(sigdir,'ecg_nm_f.mat'));
