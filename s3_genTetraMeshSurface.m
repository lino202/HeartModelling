...
% Input filenames
dataPath = 'F:\HeartModeling\NeisserModel\';
surfMesh = append(dataPath, 'surfMeshFinal2.obj');
...
minBB = min(snodes);
maxBB = max(snodes);
[nodes,elems,faces]=surf2mesh(snodes,sfaces,minBB,maxBB,1,tetMaxVol,surfSeeds,[],0);
