...
class Parameters():
    ...
    #Function to set the meshfile parameter        
    def setMeshfile(self, mesh_input):
        self.meshfile = mesh_input
        
    #Function to set the tree output file parameter
    def setFilename(self, tree_output):
        self.filename = tree_output
    
    #Function to set the initial node of the tree
    def setInitNode(self, init_node_coords):
        self.init_node=np.array(init_node_coords)
    
    #Function to set the second node of the tree  
    def setSecondNode(self, second_node_coords):
        self.second_node=np.array(second_node_coords)

    #Function to set the length of a branch
    def setLength(self, length_):
        self.length = length_
     
    #Function to set the length of a segment of the branch
    def setSegLength(self, seg_length_):
        self.l_segment = seg_length_
        
    #Function to set the angle of the branches
    
    def setAngle(self, angle_):
        self.branch_angle = angle_
        
    #Function to set the repulsion parameter of the branches
    def setRepulsion(self, w_):
        self.w = w_
    
    #Function to set the number of iterations
    def setIterations(self, iter_):
        self.N_it = iter_
